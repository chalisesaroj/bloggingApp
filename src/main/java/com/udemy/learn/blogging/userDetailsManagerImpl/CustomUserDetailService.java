...
Collection<GrantedAuthority>auth=userdb.
									getRole().stream().
									map(role->
...
new org.springframework.security.core.userdetails.User(userdb.getUserName(),
										userdb.getPassword(),true,true,true,true,auth);
